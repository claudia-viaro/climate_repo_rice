...
def initialize_ray():
    """
    Start Ray locally on this node. For single-node cluster runs, this
    starts both the head process and a worker automatically.
    """
    RAY_TMP = os.path.expanduser("~/ray_tmp")
    os.makedirs(RAY_TMP, exist_ok=True)
    ...
    ray.init(
        ...
        local_mode=False,
        _temp_dir=RAY_TMP,
        object_store_memory=1_000_000_000,  # adjust as needed
    )
    print("✅ Local Ray started successfully")
